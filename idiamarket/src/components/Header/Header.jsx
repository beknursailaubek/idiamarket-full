            ...
            <header className="header__bottom">
                <div className="header__inner container">
                    ...
                    <div className="header__search search" onClick={openSearch}>
                        ...
                        {searchQuery ? <img className="search__icon" onClick={handleSearchQuety} src={CloseIcon} alt="" /> : <img className="search__icon" src={SearchIcon} alt="" />}
                    </div>
